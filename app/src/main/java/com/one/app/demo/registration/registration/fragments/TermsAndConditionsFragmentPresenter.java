...
public class TermsAndConditionsFragmentPresenter extends FragmentPresenter {

    private final TermsAndConditionsFragmentPresenterView mView;
     ...
     */
    private TermsAndConditionsFragmentPresenter(TermsAndConditionsFragmentPresenterView view,
     ...
     * @return instance
     */
    public static TermsAndConditionsFragmentPresenter newInstance(TermsAndConditionsFragmentPresenterView view,
                                                                  RegistrationController controller) {
        return new TermsAndConditionsFragmentPresenter(view, controller);
    }
    ...
    public interface TermsAndConditionsFragmentPresenterView {
